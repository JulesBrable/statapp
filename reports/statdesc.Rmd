...
df %>%
  plot_discrete_group(var=frace6, recode_labels=recode_labels, quick_title=quick_title, x="Race") +
...
df %>%
  plot_discrete_group(var=mrace6, recode_labels=recode_labels, quick_title=quick_title, x="Race") +
  scale_x_discrete(guide = guide_axis(angle = 30))
```
...
df %>%
  plot_discrete_group(var=meduc, recode_labels=recode_labels, quick_title=quick_title, x="Education") +
...
df %>%
  plot_discrete_group(var=feduc, recode_labels=recode_labels, quick_title=quick_title, x="Education") +
  guides(fill = guide_legend(reverse=TRUE)) +
  coord_flip()
```
