...
# AI = Abadie-Imbens
save(res, file = paste0("data/", "matched_AI.Rdata"))
...
kable(data, format = "html", digits = 5, col.names = c("Method", "ATT", "se", "t-stat", "p-value", "sign"), align = "c", row.names = TRUE) %>%
  kable_styling("striped", full_width = F, position = "center") %>%
  row_spec(0, bold = T, background = "lightgray") %>%
  column_spec(6, color = "blue") %>%
  add_header_above(c(" " = 1, "Comparison of the estimation results for different matching methods" = 4))
```
</pre>
